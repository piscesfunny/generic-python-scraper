...
from custom_scraper.worldofconcrete import WorldOfConcreteSpider
...
if __name__ == '__main__':
    ...
    if spider_name == "stdaily":
        ...
        skip_item_list = True if sys.argv[4] == "yes" else False
        spider.run(skip_item_list=skip_item_list)
    elif spider_name == "worldofconcrete":
        spider = WorldOfConcreteSpider()
        skip_item_list = True if sys.argv[2] == "yes" else False
        spider.run(skip_item_list=skip_item_list)
