...
def start_scrapper(site_name, action_type, target_year=None, target_start_week=None, target_end_week=None,
    ...
    if action_type == ACTION_SCRAPPING:
        ...
        for week_dir in week_dirs:
            ...
            output_f_path = os.path.join(output_dir, f"{week}.csv")

            success_f_path = os.path.join(status_dir, f"{week}_success.txt")
            failed_f_path = os.path.join(status_dir, f"{week}_failed.txt")
